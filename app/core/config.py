...
from pydantic import Field, HttpUrl, StringConstraints, UrlConstraints, model_validator
...
class Settings(BaseSettings):
    ...
    # 오류 추적과 Slack 운영 알림
    sentry_dsn: SentryDsn | Literal[""] = ""
    sentry_environment: NonBlankString = "local"
    sentry_release: NonBlankString | Literal[""] = ""
