...
| 지수 | **KOSPI200 지수** | KIS API 업종 `2001` | T1 | 선물 베이시스 계산의 기준값 — 봉 단위 베이시스는 API가 주지 않아 선물가와 직접 뺀다 |
| 선물 | **KOSPI200 선물 (가격 + 베이시스)** | KIS API | T1 | 외국인 포지션(§수급)과 결합 해석. 주간·야간 두 세션 — 수집 설계는 [kospi200.md](kospi200.md) |
